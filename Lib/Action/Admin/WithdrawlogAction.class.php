...

{
    ...
    */
...

    {
		...
		$field= 'w.*,m.user_name,mi.real_name,w.id,w.uid,(mm.account_money+mm.back_money) all_money,w.cfg_req_sn,mi.real_name';
...
notice1(8,$vox['uid'], $data = array("MONEY"=>$vox['withdraw_money']-intval($_POST['withdraw_fee'])));
...
/**
	...
	*/
...

    {
		...
		$field= 'w.*,m.user_name,mi.real_name,w.id,w.uid,(mm.account_money+mm.back_money) all_money,w.cfg_req_sn';
