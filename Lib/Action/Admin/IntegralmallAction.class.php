<?php
// 全局设置
class IntegralmallAction extends ACommonAction
{
	var $typeleve=1;
    ...
    */
    ...
    {die;
	    ...
	    public function ord()    {		$field= true;		$this->_list(D('Aacategory'),$field,array("parent_id"=>0,"area_id"=>session("admin_area_id")),'sort_order');        $this->display();    }	
