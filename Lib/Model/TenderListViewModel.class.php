...
class TenderListViewModel extends ViewModel {
	 public $viewFields = array(
		'BorrowInvestor'=>array('id','status','borrow_id','investor_uid','borrow_uid','investor_capital','investor_interest','receive_capital','receive_interest','substitute_money','expired_money','invest_fee','paid_fee','add_time'=>'invest_time','deadline','is_auto','reward_money','_type'=>'LEFT','investor_way'=>'investor_way','member_interest_rate_id'=>'member_interest_rate_id','bonus_id'=>'bonus_id','is_experience'=>'is_experience','contractId','is_sign','step'),
