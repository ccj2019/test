...
function member_img($id=1){
$vox = D('member_info')->where("uid=".$id)->find();
$vox["user_name"] = M('members')->where("id=".$id)->find()["user_name"];
return $vox;
}
...
function getBorrowList($parm=array()){
	...
	$field = "b.art_writer,b.xs_time,b.xj_time,b.shoujia,b.sg_time,b.borrow_status,b.total,b.hkday,b.lead_time,b.id,b.borrow_name,b.pause,b.borrow_time,b.borrow_uid,borrow_img,b.borrow_info,b.borrow_con,b.pid,b.hits,b.borrow_type,b.reward_type,b.borrow_times,b.borrow_status,b.borrow_money,b.borrow_min,b.borrow_max,b.borrow_use,b.repayment_type,b.borrow_interest_rate,b.borrow_duration,b.collect_time,b.add_time,b.content_img,b.province,b.has_borrow,b.has_vouch,b.city,b.area,b.reward_type,b.reward_num,b.password,b.is_tuijian,b.danbao,IFNULL(cat.type_name,'') AS type_name,b.start_time,round(b.has_borrow/b.borrow_money*100,0) as progress,collect_day,b.bespeak_able,b.bespeak_money,b.bespeak_days";
