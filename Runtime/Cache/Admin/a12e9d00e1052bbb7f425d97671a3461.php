...
<script type="text/javascript">
  ...
  <div id="search_div" style="display:none">
	...
	<div class="form2">
	<form method="get" action="__URL__/<?php echo ($xaction); ?>/index">
   <dl class="lineD">

      <dd>
          <span>订单编号:</span><input name="ordernum" style="width:190px" id="title" type="text" value="<?php echo ($search["ordernum"]); ?>">
          <span>真实姓名:</span> <input name="name" style="width:190px" id="name" type="text" value="<?php echo ($search["name"]); ?>">
  ...
  <div class="Toolbar_inbox">
    ...
    <a class="btn_a" href="__URL__/export1?<?php echo ($query); ?>"><span>将当前条件下数据导出为Excel</span></a>
  ...
  <tr>
    ...
    <th class="line_l">会员名称</th>
    <th class="line_l">名称</th>
    <th class="line_l">折现单价</th>
    <th class="line_l">数量</th>
    <th class="line_l">折现金额</th>
    <th class="line_l">项目类型</th>
  ...
  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr overstyle='on' id="list_<?php echo ($vo["id"]); ?>">
        ...
        <td>
          <?php if($vo["ztype"] == 1): ?>常规项目<?php endif; ?>
          <?php if($vo["ztype"] == 2): ?>预购商品<?php endif; ?>
        </td>
