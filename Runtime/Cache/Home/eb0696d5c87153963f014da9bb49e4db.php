...
<div class="t-video-show">
	<div class="box">
		<ul class="clearfix">
			<!-- <?php if(is_array($list["list"])): foreach($list["list"] as $key=>$vo): ?>-->
			<a href="javascript:;" onclick="videoshow(<?php echo ($vo["id"]); ?>)"  >
			<li>
				<img src="/<?php echo ($vo["art_img"]); ?>"  width="100%" height="245px" alt="" />
				<!-- <?php if($vo["art_content"] != ''): ?><img class="pic1" src="/Public/web/img/zuixinzixun/video.png" alt="" /><?php endif; ?> -->
				<div class="show">
					<p style="color:#000;"><?php echo ($vo["title"]); ?></p>
				</div>
				<div class="bot clearfix">
					<div class="num fl clearfix">
						...
						<p class="fl"><?php echo (($vo["art_click"])?($vo["art_click"]):0); ?></p>
					</div>
					<div class="day fr">
						<!-- <p><?php echo (date('Y-m-d',$vo["art_time"])); ?></p> -->
					</div>
				</div>
			</li>
			</a>
