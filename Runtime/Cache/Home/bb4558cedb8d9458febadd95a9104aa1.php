...
<div class="l_main">
	<div class="box clearfix">	
		...
		<div class="l_mwhd">
			<img src="/<?php echo ($vo["art_img"]); ?>" width="360px" height="245px" />
			<div class="l_g1"><?php echo ($vo["title"]); ?></div>
			<div class="l-gbox">
			<p class="p1">
				<?php echo ($vo["title"]); ?>
			</p>
			<p class="p2">铭万平台活动公告</p>
			<div class="btn">
				<a href="<?php echo U('article/index',array('cid'=>$vo['type_id'],'id'=>$vo['id']));?>">
				    查看详情						
				</a>
